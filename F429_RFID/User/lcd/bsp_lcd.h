...
/*把這個宏設置成非0值 液晶屏使用RGB888色彩，若為0則使用ARGB1555色彩*/
...
/*******RGB888標頭檔***********************RGB888標頭檔***********************RGB888標頭檔***********************RGB888標頭檔***********************RGB888標頭檔***********************RGB888標頭檔***********************RGB888標頭檔***********************RGB888標頭檔***********************/
...
#define LCD_FRAME_BUFFER       ((uint32_t)0xD0000000)		//第一層首地址
#define BUFFER_OFFSET          ((uint32_t)800*480*3)     //一層液晶的數據量
...
#else
/***RGB565標頭檔*****************************RGB565標頭檔*****************************RGB565標頭檔*****************************RGB565標頭檔*****************************RGB565標頭檔*****************************RGB565標頭檔*****************************RGB565標頭檔*****************************/
...
/**
  ...
  */
/*
 *   使用以下兩組顏色必須跟LCD_LayerInit()函數中對每層的設置對應，不然會導致顏色顯示錯誤。
 * 特別為實現兩層同時正常顯示需要把上層(LCD_FOREGROUND_LAYER)設置為LTDC_Pixelformat_ARGB1555
 * 格式，對應的必須使用LCD_COLOR1555_XXX顏色，該格式在1位透明控制位，可以實現沒有實際顏色填
 * 充的圖元點通透顯示,從而使得顯示下層(LCD_BACKGROUND_LAYER)成為可能。如果上層是使用
 * LTDC_Pixelformat_ARGB565格式設置是無法正常顯示雙層的。
 *   當然，可以把下層設置為LTDC_Pixelformat_ARGB1555格式，使用用LCD_COLOR1555_XXX也是可以正
 * 常顯示的。
 * 特別注意：ARGB1555其中的A對應開發板液晶來說設置為1表示不透明，設置為0表透明。
*/
                                                   //RGB565
